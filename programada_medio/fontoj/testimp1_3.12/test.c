...
printf(" addr chn=%x , taille=%d\n",(unsigned int)&channel_attr,sizeof(channel_attr));
printf("      addr attrRcMode = %d\n",(int)((int)&channel_attr.rcAttr-(int)&channel_attr));
printf("      addr attrHSkip = %d\n",(int)((int)&channel_attr.rcAttr.attrHSkip-(int)&channel_attr));
